...
const validateArgs = (lat: number, long: number, arr: unknown[], asc: boolean): void => {
	if (isNaN(parseFloat(lat as unknown as string)) || isNaN(parseFloat(long as unknown as string)) || !arr) {
